...
export const SCENE3D_SYSTEM_INSTRUCTION = [
  ...
  "geometry.kind is one of: box, roundedBox, sphere, cylinder, cone, plane, torus, torusKnot, capsule, icosahedron, lathe. args is the THREE.js geometry args array (optional; sensible defaults applied).",
